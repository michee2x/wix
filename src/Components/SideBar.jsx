...
export const SideBar = ({children}) => {
    ...
    return (
        ...
        <aside class={`flex ${showSideBar ? "w-full px-6" : "w-0"} lg:pl-6 transition-all duration-500 fixed top-0 z-40 bottom-0 left-0 flex-col lg:w-[20%] h-screen py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700`}>
