...
export const Hero = () => {
    ...
    <div className="lg:flex">
        <div className="flex items-center justify-center w-full px-6 pt-24 pb-8 lg:h-[32rem] lg:w-1/2">
            <div className="max-w-xl ">
                <h2 className="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl animate__animated animate__flipInX animate__delay-2s">We Provide Your <span className="text-blue-600 dark:text-blue-400">Ideas</span></h2>
