        ...
        <div className="flex items-center lg:items-start justify-center w-full px-6 pt-24 lg:pt-16 pb-8 lg:h-[32rem] lg:w-1/2">
            <div className="max-w-xl ">
                ...
                <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
                    <Link to={"/auth"} className="block animate__animated animate__zoomIn animate__infinite px-5 py-2 text-sm font-medium tracking-wider text-center text-white transition-colors duration-300 transform bg-gray-900 rounded-md hover:bg-gray-700">Get Started</Link>
